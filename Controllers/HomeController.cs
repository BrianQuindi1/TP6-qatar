...
public class HomeController : Controller
{
    ...
    {
        Jugador Jug;
        Jug = BD.VerInfoJugador(IdJugador);
        BD.EliminarJugador(IdJugador);
        
        return RedirectToAction("DetalleEquipo", "Home", new {IdEquipo = Jug.idEquipo});
    }
    ...
    public IActionResult GuardarJugador(Jugador DetalleJugador, IFormFile Foto)
    {
        ...
        return RedirectToAction("DetalleEquipo", "Home", new {IdEquipo = DetalleJugador.idEquipo});
